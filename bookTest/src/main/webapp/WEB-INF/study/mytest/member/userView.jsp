...
<script>
	inputType=["text","password","text","email","tel","text","text"];
	inputName=["userId","userPw","userName","userEmail","userTel","userAddress","userBirth"];
</script>
</head>
<body>
	<form id="fm" method="get" action="/mytest/member/delete">
	<input type="hidden" name="id" value="${member.userNb }">
		<div id="wrap">
